...
final class AccountTest extends AbstractEntityTestCase
{
    ...
    public static function propertiesProvider(): array
    {
        return [
            ...
            'clientId' => ['clientId', 'test_value'],
            'clientSecret' => ['clientSecret', 'test_value'],
        ];
    }
    ...
    public function testSetAndGetClientSecret(): void
    {
        ...
        $account->setClientSecret($testClientSecret);
    ...
    public function testSettersWorkCorrectly(): void
    {
        ...
        $account->setClientId('client_id_123');
        $account->setClientSecret('client_secret_456');
